  		...
  		<div class="clearfix">
            <div class="content_l">
            	...
            	<div class="profile_box" id="basicInfo">
            		...
            		<div class="basicShow">
            			            			<span><?=$basic['user_really_name']?>|  <?php if($basic['user_sex']==1){echo "男";}else{echo "女";} ?> |    <?=$edu['edu']?> |  <?=$basic['work_exp']?><br>
            			            			<?=$basic['user_tel']?> | <?=$basic['user_email']?><br>
            			</span>
            		...
            		<div class="basicEdit dn">
            			<form id="profileForm" action="<?=Url::toRoute(['jianli/basic'])?>" method="post">
						  <table>
						    <tbody><tr>
						      <td valign="top">
						      ...
						      <td>
						        <input type="text" placeholder="姓名" value="<?=$basic['user_really_name']?>" name="user_really_name" id="user_really_name">
						      </td>
						      <td valign="top"></td> 
						      <td>
						          <ul class="profile_radio clearfix reset">
                                      <!-- 判断性别-->
                                          <li class="current">
                                              男<em></em><input type="radio" id="basic_sex" name="user_sex" value="1">
                                          </li>
                                          <li>
                                              女<em></em><input type="radio" id="basic_sex" checked="checked" name="user_sex" value="0">
                                          </li>
						          </ul>  
						      </td>
						    </tr>
						    ...
						    <tr>
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="手机号码" value="<?=$basic['user_tel']?>" name="tel" id="te">
						      </td>
						   	</tr>
						   	<tr>
						      <td valign="top">
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="接收面试通知的邮箱" value="<?=$basic['user_email']?>" name="email" id="emai">
						      </td>
						    </tr>
						    <tr>
						      <td valign="top"> </td> 
						    ...
						    <tr>
						      <td></td> 
						      <td colspan="3">
						          <input type="submit" value="保 存" class="btn_profile_save" id="basic_btn">
                        ...
                        <script>
                            $('#basic_btn').click(function () {
                                var user_really_name = $('#user_really_name').val();
                                var  user_sex =  $('#basic_sex').val();
                                alert(user_sex);
                            })
                        </script>
