...
<!-- end #header -->
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
     	        <dt><h3>帐号设置</h3></dt>
                <dd><a class="hover" href="<?=Url::toRoute(['account/index'])?>">帐号绑定</a></dd>
        <dd><a href="<?=Url::toRoute(['account/password'])?>">修改密码</a></dd>
            </dl>
</div>
        ...
        <dl class="c_section">
            ...
            <dd id="pad">
                <ul class="user_noModify">
                    <li>当前登录帐号：<span><?=$now_account['email']?></span> </li>
                    <li>绑定后，你可以同时使用以下方式登录拉勾</li>
                </ul>
                <dl class="user_thirdLogin">
                    <dt><img alt="weibo" src="style/images/qq.png"></dt>
                    <dd><a href="h/ologin/bind/qq.html">绑定QQ帐号</a></dd>
                </dl>
				<dl class="user_thirdLogin">
