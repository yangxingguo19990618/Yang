            ...
            clickInput:true
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" enctype="multipart/form-data" action="<?=Url::toRoute(['adver/add_info'])?>" method="post">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 广告名称 </label>

                                            <div class="col-sm-9">
                                                <input type="text" id="form-field-1" placeholder="请输入广告名称" name="adver_name" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="form-field-1" placeholder="例如:https://www.baidu.com" name="adver_link" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="adver_content" id="" cols="50" rows="5"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="" name="adver_start_time"/>
                                                -
                                                <input type="text" placeholder="" name="adver_end_time">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="" name="adver_sort"/>
                                            </div>
