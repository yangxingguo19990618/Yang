    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="post" action="/nav/update/">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 导航名称 </label>

                        <div class="col-sm-9">
                            <input name="nav_name" type="text" id="form-field-1" placeholder="请输入导航名称" value="<?=$nav_upd_info['nav_name']?>" class="col-xs-10 col-sm-5">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="nav_link" type="text" id="form-field-2" placeholder="请输入将要跳转的地址" value="<?=$nav_upd_info['nav_link']?>" class="col-xs-10 col-sm-5">
                        </div>
                    </div>
                    <input type="hidden" value="<?=$nav_upd_info['id']?>" name="id">
