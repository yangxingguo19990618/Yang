            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="/friend/friend_add_do/">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 连接名称 </label>

                                <div class="col-sm-9">
                                    <input name="friend_name" type="text" id="form-field-1" placeholder="请输入连接名称" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 连接地址 </label>

                                <div class="col-sm-9">
                                    <input name="friend_link" type="text" id="form-field-2" placeholder="请输入友情链接地址" class="col-xs-10 col-sm-5">
                                </div>
                            </div>
