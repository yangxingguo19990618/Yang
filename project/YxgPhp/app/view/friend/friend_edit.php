    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="post" action="/friend/update/">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 连接名称 </label>

                        <div class="col-sm-9">
                            <input name="friend_name" type="text" id="form-field-1" placeholder="请输入友情链接名称" value="<?=$friend_upd_info['friend_name']?>" class="col-xs-10 col-sm-5">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="friend_link" type="text" id="form-field-2" placeholder="请输入将要跳转的地址" value="<?=$friend_upd_info['friend_link']?>" class="col-xs-10 col-sm-5">
                        </div>
                    </div>
                    <input type="hidden" value="<?=$friend_upd_info['id']?>" name="id">
